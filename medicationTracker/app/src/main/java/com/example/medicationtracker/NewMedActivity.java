 ...
 *****************************************************************/
public class NewMedActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
    ...
    buttonRemind.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        if (medName.getText().toString().equals("")) {
          Toast.makeText(NewMedActivity.this, "Please add a medication", Toast.LENGTH_SHORT).show();
        } else {
...
//          startAlarm(mCalendar);  // set the alarm
    ...
    buttonCancel.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        if (alarmID == 0){
          Toast.makeText(NewMedActivity.this, "No alarm to cancel", Toast.LENGTH_SHORT).show();
        } else {
